...
<table>
    ...
    <td> <input type="text"  name ="username" id="username" placeholder="Enter Username"  onchange= "existuser()"  onkeyup= "checkusername()"></td><td><p id="nameerror"></p><p id="ajaxresponse"></p></td>
</tr>
<tr>
    <!-- <td>
